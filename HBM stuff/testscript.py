...
df = pd.read_csv(r'C:\Users\Dell\OneDrive - University of Birmingham\Documents\Y4 Project\y4project\HBM stuff\Files\tailo2022table.csv') 
df_first_30 = df[:32]
...
mcmc = MCMC(nuts, num_warmup=4000, num_samples=2000, num_chains=2) # between 1000 and 4000 for testing 
