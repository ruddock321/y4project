...
checkpoint_path = os.path.join(save_dir, "best_model_noLogDP-2_v11---epoch=14802-val_loss=15.23016945.ckpt")
...
# Create a base model instance for loading
model = GarstecNet(
    input_dim=input_dim, 
...
checkpoint_callback = ModelCheckpoint(
    monitor='val_loss',
    dirpath=save_dir,
    filename='best_model_noLogDP-2_v11-continued---{epoch:02d}-{val_loss:.8f}',
    save_top_k=1,
    mode='min'
)
