...
save_dir = r'/rds/projects/d/daviesgr-m4massloss/GarstecNN_V12'
...
class GarstecNet(LightningModule):
    ...
    def validation_step(self, batch, batch_idx):
        ...
        feature_names = ['teff', 'dnufit', 'numax', 'feh']
...
# Define weights for [T_eff, dnu, numax, feh]
# Note: You might need to adjust these weights since we're not using log-transformed data
loss_weights = [70, 0.1, 0.5/3090, 0.01]  # Division by 3090
...
checkpoint_callback = ModelCheckpoint(
    monitor='val_loss',
    dirpath=save_dir,
    filename='best_model_noLogDP_V12---{epoch:02d}-{val_loss:.8f}',
    save_top_k=1,
    mode='min'
)
