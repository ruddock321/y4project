...
def load_pca_components(emulatorpath, pcafile):
    # Use pcafile directly instead of joining with emulatorpath
...
def load_tf_model(emulatorpath, checkpointfile, pca_comps, pca_mean, n=25):
...
def load_emulator(run_name: str, emulatorpath: str, checkpointfile: str, pcafile: str):
    # Pass pcafile directly without expecting it to be joined with emulatorpath
    pca_comps, pca_mean = load_pca_components(None, pcafile)
...
mcmc = MCMC(nuts, num_warmup=4000, num_samples=2000, num_chains=4) # between 1000 and 4000 for testing 
